...
parser.add_argument('-prec',    dest='prec',        type=float, default=501,    help='[%(default)s] precision')
...
if args.t0>2450000 :
  print("ERROR: please use as t0 the JD - 2450000")
  exit(-1)
...
# print(  "args.rp, args.rhoplan, args.K, args.Mplan, args.Rplan" )
# print(  args.rp, args.rhoplan, args.K, args.Mplan, args.Rplan )
    ...
    if args.rhoplan == 0. :
        if args.K > 0 :
            ...
            if args.Mplan == 0. and args.Rplan == 0. :
                ...
                params2.rhoplan = calc_rhoplan__Mplan_Rplan(params2)
                #print("params2.Rplan",params2.Rplan  )
                #print("params2.Mplan",params2.Mplan  )
                #print("params2.rhoplan",params2.rhoplan  )
        ...
        params2.rhoplan = args.rhoplan
        if args.K == 0 :
           if args.rhoplan != 0. and params2.Rplan != 0. and args.Mplan == 0. :
               params2.Mplan   = calc_Mplan__rhoplan_Rplan(params2)
               params2.K       = calc_K__Mplan(params,params2)
           else :
              print(">>>>inconsistent given parameters:")
...
#print("params2.Mplan,params2.K")
#print(params2.Mplan,params2.K)

#print(  "params.rp, params2.rhoplan, params2.K, params2.Mplan, params2.Rplan" )
#print(  params.rp, params2.rhoplan, params2.K, params2.Mplan, params2.Rplan )
...
slider_rhoplan   = Slider(ax_rhoplan,   title_rhoplan, valmin=0.,             valmax=20.,            valfmt="%1.3f", valinit=params2.rhoplan, color='b')
...
slider_update_rhoplan(params2.rhoplan)
plt.show()
